...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const dichvu = yield dichvukhambenh_model_1.default.find(find);
        res.json({
            code: 200,
            dichvu: dichvu,
        });
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = new dichvukhambenh_model_1.default(req.body);
        yield data.save();
        res.json({
            code: 200
        });
...
const detail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const dichvu = yield dichvukhambenh_model_1.default.findOne({
            _id: id,
            deleted: false
        });
        res.json({
...
const edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield dichvukhambenh_model_1.default.updateOne({ _id: id }, req.body);
        const dichvu = yield dichvukhambenh_model_1.default.findOne({
            _id: id
        });
        res.json({
...
const deleted = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield dichvukhambenh_model_1.default.deleteOne({ _id: id });
        res.json({
            code: 200,
        });
    }
