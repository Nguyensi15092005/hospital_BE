...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        ;
        const tintuc = yield tintucvasukien_model_1.default.find(find);
        res.json({
            code: 200,
            tintuc: tintuc
        });
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = new tintucvasukien_model_1.default(req.body);
        yield data.save();
        res.json({
            code: 200
        });
...
const detail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tintuc = yield tintucvasukien_model_1.default.findOne({
            _id: id
        });
        res.json({
            code: 200,
...
const edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield tintucvasukien_model_1.default.updateOne({ _id: id }, req.body);
        const tintuc = yield tintucvasukien_model_1.default.findOne({
            _id: id
        });
        res.json({
...
const del = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield tintucvasukien_model_1.default.deleteOne({ _id: id });
        res.json({
            code: 200,
        });
    }
