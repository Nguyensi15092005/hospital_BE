...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const banner = yield banner_model_1.default.find({
            deleted: false
        });
        res.json({
            code: 200,
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = new banner_model_1.default(req.body);
        yield data.save();
        res.json({
            code: 200,
        });
...
const edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield banner_model_1.default.updateOne({ _id: id }, req.body);
        const banner = yield banner_model_1.default.findOne({
            _id: id
        });
        res.json({
...
const del = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        yield banner_model_1.default.deleteOne({ _id: id });
        res.json({
            code: 200,
        });
    }
